...
z <- xtable::xtable(list_table_post_hurr_CTC[[list_depts]], caption = paste0("Répartition des cas de diarrhées aigues par CTC/UTC, ", list_dat_post_hurr[[list_depts]]$date %>% min %>% format('%d %b %Y'), " - ", list_dat_post_hurr[[list_depts]]$date %>% max %>% format('%d %b %Y'), " Grand’Anse (données partielles)."), digits = 0, label = "tab_overview")
...
<!-- # library(xtable) -->
<!-- # print(xtable(list_table_post_hurr_CTC[[list_depts]]), scalebox='0.75') -->

<!-- knitr::kable( -->
<!--   list_table_post_hurr_CTC[[list_depts]], caption = paste0("Répartition des cas de diarrhées aigues par CTC/UTC, ", list_dat_post_hurr[[list_depts]]$date %>% min %>% format('%d %b %Y'), " - ", list_dat_post_hurr[[list_depts]]$date %>% max %>% format('%d %b %Y'), " Grand’Anse (données partielles).") -->
<!-- ) -->
<!-- ``` -->
